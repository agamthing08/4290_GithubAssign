...
from utils.dead_enemy import *
from utils.enemy import *
from utils.tower import *

FPS = 60 #frames per second, the speed rate of the prgram
WINDOWWIDTH = 1200 #window's width in pixel
...
def main():
	...
	ENEBASE = pygame.image.load('sprites/enemyBase.png')
	OURBASE = pygame.image.load('sprites/base.png')
	bubbleImage = pygame.image.load('sprites/barbican_1.png')
	solidImage = pygame.image.load('sprites/barbican_2.png')
	blockImage = pygame.image.load('sprites/rock.png')
	pauseImage = pygame.image.load('sprites/pause.png')
	helpImage = pygame.image.load('sprites/help.png')
	...
	soundCannotPlace = pygame.mixer.Sound('audio/coolTime.wav')
...
def startScreen():
	title = pygame.image.load('sprites/tower_title.png')
...
def SelectedTower(mousex, mousey):
	if mousex >= 880 and mousex <=930 and mousey >=270 and mousey <= 340:
		return pygame.image.load('sprites/barbican_1.png'), '1'
	elif mousex >= 960 and mousex <= 1010 and mousey >=270 and mousey <= 340:
		return pygame.image.load('sprites/barbican_2.png'), '2'
	elif mousex >= 1040 and mousex <= 1090 and mousey >= 270 and mousey <= 340:
		return pygame.image.load('sprites/rock.png'), '3'
...
def getGridAtPixel(mousex, mousey):
	gridx = int((mousex - 40) / 50)
	gridy = int((mousey - 60) / 40)
...
def halt():
	haltImage = pygame.image.load('sprites/tower_paused.png')
...
def gameover():
	gameOverImage = pygame.image.load('sprites/gameover.png')
...
def help():
	helpImage = pygame.image.load('sprites/helpInstr.png')
